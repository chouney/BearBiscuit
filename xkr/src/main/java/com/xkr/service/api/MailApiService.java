...
public class MailApiService {
    ...
    @Async
    public void sendRegValidCaptcha(String email,String userName,String captcha) throws MessagingException {
...
//                .html("您好，您的账号<b>"+userName+"</b>已经注册成功，请您<a href=\""+frontDomain+"/front_pages/checkEmail.html?token=" + captcha + "\">点此链接</a>进行激活操作，没有激活的账号无法正常使用，此链接转发无效。")
    ...
    @Async
    public void sendPasswordUpdateValidCaptcha(String email,String userName,String captcha) throws MessagingException {
        OhMyEmail.subject("sharecoder邮箱验证")
                .from("sharecoder.cn")
                .to(email)
